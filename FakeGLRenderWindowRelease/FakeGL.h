...
class screenVertexWithAttributes
    ...
    //Frag
    Cartesian3 fragLightVector;
    Cartesian3 fragEyeVector;
...
class FakeGL
    ...
    int fakeTextureMode = -1;

    RGBAImage textureBuffer;

    float textureRed = 0;
    float textureGreen = 0;
    float textureBlue = 0;
    float textureAlpha = 0;

    float textureCoordU = 0;
    float textureCoordV = 0;
    ...
    std::stack<Matrix4> matrixModeMatrices;

    std::stack<Matrix4> modelViewMatrices;

    std::stack<Matrix4> projectionMatrices;

    int matrixModeMatrix = -1;
    ...
    bool texture2DEnable = false;
    bool depthTestEnable = false;
    bool phongShadingEnable = false;
    ...
    float ambientAndDiffuseMaterial[4];
    float specularMaterial[4];
    float specularCoefficientMaterial;
    ...
    float clearColorRed = 0.0;
    float clearColorGreen = 0.0;
    float clearColorBlue = 0.0;
    float clearColorAlpha = 0.0;
